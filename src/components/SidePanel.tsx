    ...
    <div className={cn("flex flex-col relative group overflow-hidden min-h-0", className)}>
      ...
      <div className="flex items-center gap-2 px-2 py-1.5 mb-1 relative shrink-0 bg-gradient-to-r from-[#0f172a] to-transparent border-l-2 border-[#0ea5e9]">
        ...
        <div className="ml-auto flex gap-[3px] opacity-50">
            <div className="w-[2px] h-[12px] bg-[#0eb7e9] skew-x-[12deg]" />
            <div className="w-[2px] h-[12px] bg-[#0ea5e9] skew-x-[12deg]" />
            <div className="w-[2px] h-[12px] bg-slate-600 skew-x-[12deg]" />

        </div>
        <div className="absolute bottom-0 left-0 w-full h-[1px] bg-gradient-to-r from-[#0ea5e9]/50 to-transparent" />
      </div>

      <div className="flex-1 relative pl-1 min-h-0 overflow-hidden">
        {children}
      </div>
    </div>
  );
